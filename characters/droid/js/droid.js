...
$(".right_arrow").click(function(){
  ...
  localStorage.setItem("avtive_personajes_droid", activePerson);
}); 
...
function active_personajes(){
  ...
  setTimeout(function(){
         location.href = "more_droid/" + $(".active_slide").attr("alt") + "/" + $(".active_slide").attr("alt") + ".html";
  }, time);
...
function getActive_Personajes(){
    let localStorage_person_active = localStorage.getItem("avtive_personajes_droid");
