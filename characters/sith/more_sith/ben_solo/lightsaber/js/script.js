...
function second_colo_position(){
  ...
  $(".colo_active_texts2").css("top", colo_position.top/1.5);
  $(".colo_active_texts2").css("left", colo_position.left/3);

  $(".colo_active_texts1").css("top", colo_position_2.top/1.3);
