...
$(".right_arrow").click(function(){
  ...
  localStorage.setItem("avtive_personajes_jedi", activePerson);
}); 
...
function active_personajes(){
  ...
  if(window_width <= 768) time = 1000;
 	...
 	setTimeout(function(){
         location.href = "more_jedi/" + $(".active_slide").attr("alt") + "/" + $(".active_slide").attr("alt") + ".html";
 	}, time);
...
function getActive_Personajes(){
    let localStorage_person_active = localStorage.getItem("avtive_personajes_jedi");
